/*
  ...
  1. New Tables
    - `fractal_glyphs`
      ...
      - `parameters` (jsonb, required - stores sigil generation data)
      - `created_at` (timestamp)

  2. Security
    - Enable RLS on `fractal_glyphs` table
    - Add policies for authenticated users to manage their own sigils
*/
...
-- Create policies for authenticated users to manage their own fractal glyphs
